...
const ShowResultAdministrative = () => {
	...
	const AdministrativeA = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.KempfJp, 0);
	const AdministrativeB = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.BraquetM, 0);
	const AdministrativeC = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.HirakiF, 0);
	const AdministrativeD = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.ToureM, 0);
	const AdministrativeE = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.TabbouA, 0);
	const AdministrativeF = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.FournierS, 0);
	const AdministrativeG = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.FuchsM, 0);
	const AdministrativeH = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.DjeffelA, 0);
	const AdministrativeI = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.BulotS, 0);
	const AdministrativeJ = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.ChlaitK, 0);
	const AdministrativeK = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.AssalB, 0);
	const AdministrativeL = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.MekhloufiB, 0);
	const AdministrativeM = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.PelmarT, 0);
	const AdministrativeN = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.BonillaA, 0);
	const AdministrativeO = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.JossoB, 0);
	const AdministrativeP = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.KalilouS, 0);
	const AdministrativeQ = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.ZenafN, 0);
	const AdministrativeR = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.SandrineV, 0);
	const AdministrativeS = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.HammoutiA, 0);
	const AdministrativeT = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.HuetF, 0);
	const AdministrativeU = resultAdministrative.reduce((a, b) => a + b.data.results_administrative.PoulainS, 0);
