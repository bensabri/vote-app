	...
	return (
		<div className='bg-white rounded-md shadow-md mt-vh px-4 mx-4'>
			<div className='flex flex-col py-8'>
				<h2 className='text-center pb-5 font-medium self-center text-xl sm:text-2xl uppercase text-gray-500'>Commission de Contrôle</h2>
				...
				<div className='mb-6 mt-6 flex justify-between text-gray-500 font-semibold'>
					...
					<h3 className='mr-5 uppercase'>Nombre de vote {resultControle.length}</h3>
				</div>
