...
const CandidatureBureau = ({ mandat, syndicat, email }) => {
	...
	const { resultBureau, query, procurationUsers, step, setStep } =
		useGlobalContext();
		...
		<div>
			{voted?.data.thirdVote ? (
				<>
					...
					<div className="w-11/12 m-auto bg-white flex flex-col justify-between pl-3 pr-3 shadow-lg rounded uppercase py-8 mb-8">
						<h2 className="text-center pb-5 font-medium self-center text-xl sm:text-2xl uppercase text-gray-500 mb-vh">
							Vous allez être redirigé vers les résultats en
							direct
						</h2>
						<Box sx={{ width: '100%' }}>
							<LinearProgress />
							...
							<div className="p-6 space-y-4">
								...
								<div className="flex items-start">
									<div className="flex items-center h-5">
										...
										/>{' '}
										<label htmlFor="a">
											<span className="ml-3 text-xs sm:text-sm lg:text-base font-medium text-gray-700 cursor-pointer">
												Je vote Blanc
											</span>
										</label>
									</div>
