		...
		<>
			<div className='flex flex-col items-center justify-center'>
				<div className='flex flex-col bg-white shadow-md px-10 sm:px-10 md:px-10 lg:px-16 py-10 rounded-md w-full max-w-xl mt-vh z-10'>
					...
					<form onSubmit={handleSendEmail}>
						<div className='flex flex-col mb-6'>
							...
							<div className='relative'>
								<input id='email' ref={emailRef} type='email' name='email' className='text-sm sm:text-base placeholder-gray-500 pl-2 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400' placeholder='E-Mail Address' />
							</div>
						</div>
					...
					<div>
						<h2 className='border-t-2 mt-7 pt-5 font-medium text-center text-xl sm:text-lg uppercase text-gray-500'>Envoyer les emails</h2>
						<button onClick={handleSendAllEmail} className='mt-3 flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in'>
