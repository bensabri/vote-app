...
BRIGITTE ASSAL = [
    // CLUB MED assalbrigitte92@gmail.com mandat 15 // 
    DESMAZIERES-CHAUSSEXPO, mandat 2
    CYRILLUS, mandat 4
    AVIGNON TOURISME, mandat 1
    MOVITEX, mandat 7
] total 29

CHARLES MIGUAN = [
    // SECURITE 3 migan.unsa@yahoo.fr mandat 16 //
    SMCP, mandat 3
    BON MARCHE, mandat 1
    AKTO, mandat 2
] total 22
...
ABDERRAZAK DJEFFEL = [
    // NETTOYAGE 2 unsa.proprete.nettoyage@gmail.com mandat 194 //
    GALERIES LAFAYETTES, mandat 1
] total 195

EL BACHIR MEKHLOUFI = [
    // NETTOYAGE 3 unsa.nettoyage@unsa.org // mandat 78
    KUONI- TRAVEL LAB, mandat 3
    AMPLITEL, mandat 1
    JEAN MOULIN/JETLY, mandat 1
    HAPPY CHIC, mandat 1
] total 84

FATIHA HIRAKI = [
    // SNSCS hfati@hotmail.fr // mandat 153
    CARREFOUR MARKET, mandat 99
] FATIHA HIRAKI 252

FRANCK MARTINEZ = [
    // DECATHLON franck.martinez3@wanadoo.fr // mandat 105
    J.A. DELMAS, mandat 7
    KUONI GTS, mandat 2
] FRANCK MARTINEZ 114

FREDDY HARDET = [
    // CARREFOUR SUPPLY CREPY freddy.hardet@orange.fr // mandat 33
    RLS CE SNECMA, mandat 4
    SERM  mandat 2
] FREDDY HARDET 39
...
KALILOU SIDIBE = [
    // SECURITE 2 sidibekalilou@yahoo.fr // mandat 186
    ABERCROMBIE,  mandat 5
    SECURITE 7, // NOT AVAILABLE mandat 21
    ASTEN SANTE, mandat 3
    CASINO GD. CERCLE mandat 5
] KALILOU SIDIBE 220
...
MARYSE FUCHS = [
    ...
    SONEPAR, mandat 16
    PRIMAVISTA, mandat 15
    D3T DISTRIBUTION, mandat 4
...
// EMAIL A ENVOYER POUR LES VOTES PAR PROCURATION
[
    lakram@hotmail.fr,
    ...
    compass@unsa.org
    missing emails
    ABDELALI ELHAMOUTI, ECOLAB, MICHEL BRAQUET
]
