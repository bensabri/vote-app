	...
	return (
		<div className='flex flex-col items-center bg-gray-300'>
			<div className='flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md mt-vh z-10'>
				<div className='font-medium self-center text-xl sm:text-2xl uppercase text-gray-800'>Connectez-vous</div>
					...
					<form onSubmit={handleSubmit}>
						<div className='flex flex-col mb-6'>
							...
							<div className='relative'>
								...
								<input id='email' ref={emailRef} type='email' name='email' className='text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400' placeholder='E-Mail' />
							</div>
						</div>
						<div className='flex flex-col mb-6'>
						...
						<div className='flex flex-col mb-6'>
							...
							<div className='relative'>
								...
								<input id='password-confirm' ref={passwordConfirmRef} type='password' name='password-confirm' className='text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400' placeholder='Password' />
							</div>
						</div>
						<div className='flex w-full'>
							<button disabled={loading} type='submit' className='flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in'>
